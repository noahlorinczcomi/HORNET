...
parser.add_argument('-n','--novelKbWindow',action='store',type=float,default=500,help='(Optional) Genes detected in HORNET must be at least this many Kb away from any known outcome signals to be considered novel. The default is 500, which means 500Kb.')
