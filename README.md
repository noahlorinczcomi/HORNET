...
Lorincz-Comi, N., Yang, Y., Li, G., & Zhu, X. (2024). MRBEE: A bias-corrected multivariable Mendelian randomization method. Human Genetics and Genomics Advances, 5(3). doi: https://doi.org/10.1016/j.xhgg.2024.100290. 

Lorincz-Comi, N., Yang, Y., Ajayakumar, J., Mews, M.A., Bermudez, V., Bush, W. & Zhu, X. (2024) HORNET: Tools to find genes with causal evidence and their regulatory networks using eQTLs, *Bioinformatics Advances, 5*(1). doi: https://doi.org/10.1093/bioadv/vbaf068.
