...
for _ in range(0, len(os.listdir(dirGene))):
    ...
    if saveData: 
        ...
        numpy.savetxt(fpout+'genes.txt',numpy.array(outerDict[ln]['data']['Gene']))
        numpy.savetxt(fpout+'snps.txt',numpy.array(outerDict[ln]['data']['IVs']))
        numpy.savetxt(fpout+'geneBPs.txt',numpy.array(outerDict[ln]['data']['GeneBP']))
